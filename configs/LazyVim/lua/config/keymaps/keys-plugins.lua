...
local function toggle_signature_help()
  -- Si ya hay una ventana flotante abierta, la cerramos
  for _, win in ipairs(vim.api.nvim_list_wins()) do
    local config = vim.api.nvim_win_get_config(win)
  ...
  -- Si no hay flotante, abrimos signature help
  vim.lsp.buf.signature_help()
end
...
vim.api.nvim_create_autocmd("LspAttach", {
  callback = function(event)
    ...
    -- Navegación
    keymap.set("n", "sf", vim.lsp.buf.definition, lsp_opts("LSP: Go to definition"))
    keymap.set("n", "gD", vim.lsp.buf.declaration, lsp_opts("LSP: Go to declaration"))
    keymap.set("n", "gi", vim.lsp.buf.implementation, lsp_opts("LSP: Go to implementation"))
    keymap.set("n", "gr", vim.lsp.buf.references, lsp_opts("LSP: References"))
    ...
    keymap.set("n", "<leader>rn", vim.lsp.buf.rename, lsp_opts("LSP: Rename symbol"))

    -- Diagnósticos
    keymap.set("n", "<leader>e", vim.diagnostic.open_float, lsp_opts("LSP: Show diagnostic"))
    keymap.set("n", "[d", vim.diagnostic.goto_prev, lsp_opts("LSP: Previous diagnostic"))
    keymap.set("n", "]d", vim.diagnostic.goto_next, lsp_opts("LSP: Next diagnostic"))

    -- Cerrar flotantes
    keymap.set("n", "<leader>lc", close_lsp_floats, lsp_opts("LSP: Close floating windows"))
    ...
    end, lsp_opts("LSP: Toggle inlay hints"))
  end,
})
